package com.example.temeratureconverter;
...
import com.example.temeratureconverter.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    radio_buttons get_radio_button_status(){
        ...
        if(radioButton.getText().toString().equals("Celsius to Fahrenheit")){
            return radio_buttons.CELSIUS_TO_FAHRENHEIT;
        }else{
            return radio_buttons.FAHRENHEIT_TO_CELSIUS;
        }
    }
